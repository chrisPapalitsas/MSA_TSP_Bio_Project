...
tspFileName=['data_Read/tsp/results_dataset1//Score' seqNum '.txt'];
%tspFileName='data_Read/tsp/results_dataset1/S_distance_212_results.txt';
...
%read Score file
scoreName=['data_Export/ref10/distance_Matrices/Score' seqNum '.txt'];
